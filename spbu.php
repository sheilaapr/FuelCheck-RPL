  ...
  <header class="bg-white shadow sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <nav class="hidden md:flex space-x-6">
        ...
        <a href="admin.php" class="text-red-600 hover:text-primary">Admin Panel</a>
        <?php endif; ?>
    ...
    <div class="bg-white p-6 rounded-xl shadow mb-10">
      <?php if ($spbu): ?>
        ...
        <div class="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded">
          <span class="font-semibold text-yellow-700">Fitur Admin:</span> Anda bisa mengelola data SPBU dan laporan di halaman admin.
        </div>
        <?php endif; ?>
      <?php else: ?>
        <h1 class="text-2xl font-bold text-red-600 mb-2">SPBU Tidak Ditemukan</h1>
        <p class="text-gray-600 text-sm">Data SPBU tidak tersedia.</p>
      <?php endif; ?>
    </div>
