...
<body class="bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            <a href="dashboardUser.php" class="font-['Pacifico'] text-2xl text-primary">FuelCheck</a>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Lapor Kecurangan</h3>
                    <p class="text-gray-600">Laporkan kecurangan BBM di SPBU secara mudah dan cepat. Sertakan bukti dan deskripsi untuk membantu proses verifikasi.</p>
                    <a href="lapor.php" class="inline-block bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-transform transform hover:scale-105 duration-300 shadow-md mt-4">Laporkan Sekarang</a>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="ri-star-line ri-xl text-secondary"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Tulis Ulasan Kepuasan</h3>
                    <p class="text-gray-600">Berikan rating dan ulasan kepuasan Anda terhadap SPBU yang pernah dikunjungi. Bantu pengguna lain memilih SPBU terbaik.</p>
                    <a href="ulasan_spbu.php" class="inline-block bg-gradient-to-r from-green-500 to-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-transform transform hover:scale-105 duration-300 shadow-md mt-4">Tulis Ulasan</a>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="ri-shield-check-line ri-xl text-primary"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Melihat Data yang Sudah Diverifikasi oleh Admin</h3>
                    <p class="text-gray-600">Pantau status laporan Anda yang telah diverifikasi admin. Data yang tampil sudah melalui proses validasi dan verifikasi.</p>
                    <a href="#laporan-terkini" class="inline-block bg-gradient-to-r from-indigo-500 to-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-transform transform hover:scale-105 duration-300 shadow-md mt-4">Lihat Laporan Saya</a>
                </div>
            </div>
        </div>
    </section>
...
<!-- Laporan Terkini -->
    <section id="laporan-terkini" class="py-8 bg-white rounded-xl shadow mb-10">
    <div class="px-4">
        <h2 class="text-3xl font-bold text-center mb-4">Laporan Terkini</h2>
        <p class="text-gray-600 text-center mb-8">Laporan kecurangan BBM Anda yang telah diverifikasi admin</p>
        ...
        <table class="min-w-full bg-white rounded-lg overflow-hidden">
            ...
            $laporan = $conn->query("SELECT l.*, s.nama_spbu, s.lokasi FROM laporan l JOIN spbu s ON l.spbu_id = s.id WHERE l.user_id = '$user_id' AND l.status = 'verifikasi' ORDER BY l.created_at DESC");
